...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Skynet Mission Control — Personal AI Operations" },
      {
        name: "description",
        content:
          "Read-only observability dashboard for Claude Code workspaces, skills, memory, runs and outputs.",
      },
      { property: "og:title", content: "Skynet Mission Control — Operator Dashboard" },
      { name: "twitter:title", content: "Skynet Mission Control — Operator Dashboard" },
      {
