...
export const Route = createFileRoute("/settings")({
  head: () => ({
    meta: [
      { title: "Settings — Skynet Mission Control" },
      {
        name: "description",
        content:
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
        ...
        <Group title="CLAUDE.md scan paths" icon={FileText}>
          {/* TODO: derive from ~/.skynet-mission-control/config.json once the wizard writes it. */}
        ...
        <Group title="Output folders" icon={Archive}>
          {/* TODO: derive from ~/.skynet-mission-control/config.json. */}
