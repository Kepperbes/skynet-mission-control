# Skynet OS — Agent Instructions

You are helping a user set up and customize their personal Skynet OS dashboard.

> ## ⚠️ Mandatory: upstream integration gate
> Before performing any upstream integration, selective feature port,
> upgrade comparison, or adoption of functionality from an external
> source, you MUST read and follow
> `ALFRED-UPSTREAM-FEATURE-PORT-PROTOCOL.md`.
> Skynet Mission Control is authoritative. Never synchronize or replace
> the local product with upstream code. Port only the requested capability
...
```
Hey! Welcome to Skynet OS — your personal AI operator dashboard.
