...
**Consumption context:** someone downloads Skynet OS as files and runs it. No
...
- On load it hydrates instantly from the last cached pull (`localStorage:
  skynet-mission-control-model-live`) — so even offline you see the last-known live prices,
